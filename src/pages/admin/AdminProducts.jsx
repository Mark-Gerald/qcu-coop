...
export default function AdminProducts() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f1f5f9' }}>
      {/* Header — RESPONSIVE, NO DUPLICATES */}
      <div style={{
        background: 'white',
        ...
        {/* Top Row: Back link, Title, Add Button */}
        <div style={{
          display: 'flex',
          alignItems: 'center',
      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto', padding: 'clamp(16px, 3vw, 32px)' }}>
        {/* Product Grid */}
        {filtered.length === 0 ? (
          <div
            style={{
          ...
          >
            ...
            <p style={{ color: '#94a3b8', fontSize: '0.875rem' }}>No products found.</p>
          </div>
        ) : (
          <div
            style={{
            ...
            {filtered.map((p) => (
              ...
              >
                <div style={{ position: 'relative', height: '160px', background: '#f1f5f9' }}>
                  <img
                    src={p.image_url || 'https://placehold.co/240x160?text=No+Image'}
                    alt={p.name}
                ...
                <div style={{ padding: '14px', flex: 1, display: 'flex', flexDirection: 'column' }}>
                  ...
                  <p style={{ margin: '0 0 10px', color: '#64748b', fontSize: '0.8rem', flex: 1 }}>
            ...
            <div style={{ display: 'flex', gap: '10px', marginTop: '24px' }}>
              ...
              <button
                ...
                style={{
                  flex: 2,
                  padding: '12px',
                  background: loading ? '#9ca3af' : '#1a2e5a',
                  color: 'white',
                  border: 'none',
                  borderRadius: '10px',
      ...
      {deleteConfirm && (
        ...
        >
          ...
          >
            ...
            <h3 style={{ color: '#1a2e5a', marginBottom: '8px', fontWeight: '700' }}>Delete Product?</h3>
